		...
		return (
			...
			>
				...
				<Button
					...
					className="mt-2"
					style={{ background: "var(--mint)", color: "var(--surface-0)" }}
				>
					...
					<div>
						<div className="flex items-center justify-between mb-2">
							<div className="flex items-center gap-1.5">
								<span
									className="flex h-4 w-fit px-1 items-center justify-center rounded-sm text-[7px] font-black uppercase"
									style={{
							...
							{hookText && !hookGenerating && (
								<button
									...
									style={{
										background: hookCopied
											? "var(--accent-dim)"
											: "var(--surface-1)",
										border: "1px solid var(--border-subtle)",
										color: hookCopied ? "var(--accent-color)" : "var(--text-2)",
									}}
								>
							...
							<ul className="flex flex-col gap-2">
								{displayGaps.map((gap, i) => (
									<li
										...
										style={{ color: "#FCA5A5" }}
									>
										<span className="mt-[2px] shrink-0 text-xs text-[#EF4444]">
											✕
										</span>
										<span>{gap}</span>
									</li>
